...
const S = {
  ...
  title: { fontSize: 18, fontWeight: 600, color: '#00203E' },
  subtitle: { fontSize: 12, color: '#666', marginTop: 4 },
  warning: { fontSize: 11, color: '#A6512F', background: 'rgba(204,145,94,0.08)', border: '1px solid rgba(204,145,94,0.2)', borderRadius: 6, padding: '8px 12px', marginTop: 10 },
  section: { marginBottom: 20 },
  sectionTitle: { fontSize: 12, fontWeight: 700, color: '#00203E', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
  select: { width: '100%', maxWidth: 400, padding: '8px 12px', borderRadius: 6, border: '1px solid #ccc', fontFamily: 'inherit', fontSize: 12, color: '#333', background: '#fff', cursor: 'pointer' },
  fileInput: { fontFamily: 'inherit', fontSize: 12, color: '#333' },
  hint: { fontSize: 10, color: '#999', marginTop: 4 },
  loading: { fontSize: 11, color: '#CC915E', marginTop: 6 },
  error: { fontSize: 11, color: '#EF4444', marginTop: 6, background: 'rgba(239,68,68,0.06)', padding: '6px 10px', borderRadius: 4 },
  previewWrap: { maxHeight: 400, overflow: 'auto', border: '1px solid #eee', borderRadius: 6 },
  table: { width: '100%', borderCollapse: 'collapse', fontSize: 11 },
  th: { padding: '8px 10px', textAlign: 'left', fontWeight: 700, fontSize: 9, textTransform: 'uppercase', letterSpacing: 0.5, color: '#fff', background: '#00203E', position: 'sticky', top: 0, zIndex: 2 },
  td: { padding: '6px 10px', borderBottom: '1px solid #eee', color: '#333', fontSize: 11 },
  confirmBox: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(0,32,62,0.04)', border: '1px solid rgba(0,32,62,0.1)', borderRadius: 8, padding: '14px 18px', gap: 16 },
  confirmText: { fontSize: 12, color: '#00203E', lineHeight: 1.5 },
  ...
  resultado: { marginTop: 16, padding: '12px 16px', borderRadius: 6, border: '1px solid', fontSize: 12, fontWeight: 500 },
}
