...
export default function Hub() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg0, #00112C)', fontFamily: 'Montserrat', display: 'flex', flexDirection: 'column' }}>
      {/* Topo */}
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 22, justifyContent: 'center', padding: '48px 36px', maxWidth: 1100, margin: '0 auto' }}>
        {visiveis.map(m => (
          ...
          >
            <div style={{ fontSize: 30, marginBottom: 14 }}>{m.icone}</div>
